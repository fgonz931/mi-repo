...
//Dado el siguiente array de alumnos de una clase Obtener un array con 
//los números de alumno de aquellos alumnos que hayan
//aprobado la materia. 
...
function entreganum (element){
  return element.numAlumno;
}

const resultado = alumnos.filter(aprobados).map(entreganum);
